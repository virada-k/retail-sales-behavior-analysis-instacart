...
**Note:** Some points are interactive, such as between "Donut Chart" and "Scatter Plot", and "Scatter Plot" and the "Table". Alternatively, you can interact between two graphs ("Donut Chart & Scatter Plot") and one table simultaneously.
